...
int main(int argc,char** argv){
    ...
    printf("Multplication des polynômes entre eux : ");
    ...
    p_creux3 = multiplication_polynomes_creux(p_creux1,p_creux2);
    printf("Multiplication des polyômes creux entre eux : ");
